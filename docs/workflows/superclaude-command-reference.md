...
| **旧 E2E 工具** | E2E 回归测试自动化 | Web UI 测试 (仅适用于 HTML5/Web 版本) | `--mcp 旧 E2E 工具` |
...
| 旧 E2E 工具 | E2E 回归测试 | `--mcp 旧 E2E 工具` (仅 Web 版) |
...
5. **MCP 工具最小化**: 默认仅启用 serena, 按需添加 context7/旧 E2E 工具
