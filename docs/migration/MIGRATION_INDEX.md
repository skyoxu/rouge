...
| 层次 | 原技术栈 (旧项目) | 新技术栈 (rouge) | 迁移复杂度 |

|------|-------------------|-------------------|----------|

| 桌面容器 | 旧桌面壳 | Godot 4.5 |  |

| 游戏引擎 | 旧前端游戏引擎 3 | Godot 4.5 (Scene Tree) |  |
...
| E2E测试 | 旧 E2E 工具 (旧桌面壳) | Godot Headless + 自建Runner |  |
...
- 旧 E2E 工具 E2E → Godot Headless 测试（测试框架完全替换）
...
4. **分支并行**：保留 旧项目 主分支，rouge 在独立分支开发
