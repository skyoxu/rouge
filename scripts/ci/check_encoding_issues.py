...
UTF8_FILES = [
    ...
    "adr/ADR-0002-legacy-desktop-shell-security.md",
    ...
    "migration/legacy-overlays/PRD-Guild-Manager/08/08-Contracts-CloudEvent.md",
    "migration/legacy-overlays/PRD-Guild-Manager/08/08-Contracts-CloudEvents-Core.md",
    "migration/legacy-overlays/PRD-Guild-Manager/08/08-Contracts-Guild-Manager-Events.md",
    "migration/legacy-overlays/PRD-Guild-Manager/08/08-Contracts-Preload-Whitelist.md",
    "migration/legacy-overlays/PRD-Guild-Manager/08/08-Contracts-Quality-Metrics.md",
    "migration/legacy-overlays/PRD-Guild-Manager/08/08-Contracts-Security.md",
    "migration/legacy-overlays/PRD-Guild-Manager/08/08-功能纵切-公会管理器.md",
    "migration/legacy-overlays/PRD-Guild-Manager/08/_index.md",
